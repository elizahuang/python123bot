window.onload = function() {
    ...
    const defaultLiffId = "1654305761 - x8E3wwA0" //process.env.LIFF_ID; // change the default LIFF value if you are not using a node server
...
function initializeApp() {
    document.querySelector("form").action = process.env.SERVER_URL + '/addUser';
    //document.querySelector("form").action = process.env.SERVER_URL + '/addUser';
